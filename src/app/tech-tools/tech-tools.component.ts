...
export class TechToolsComponent implements OnInit {
  ...
  categories: TechCategory[] = [
      ...
      items: [
        {
          ...
          image: assetUrl('nestjs.svg'),
        },
        {
          name: "ASP.NET",
          description:
            "ASP.NET is a free, open-source web framework from Microsoft for building modern web apps and services with .NET. It's a server-side web application framework that allows developers to create dynamic web pages, applications, and services.",
        ...
        },
        {
          name: "Laravel",
          description:
            "Laravel is a PHP framework designed for building web applications. It follows the MVC pattern and offers robust tools for modern web development.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          image: assetUrl('skills/python.svg'),
        },
        {
          name: "Golang",
          description:
        ...
        },
        {
          name: "TypeScript",
          description:
            "TypeScript is a superset of JavaScript that compiles to plain JavaScript and provides static types.",
          link: "https://www.typescriptlang.org/",
          image: assetUrl('typescript.svg'),
        },
        {
          name: "PHP",
          description:
    ...
    },
    {
      ...
      subtitle: "Caching, Message Queue, & Event Stream",
      items: [
        {
          name: "Rabbit MQ",
          description:
          ...
          image: assetUrl('skills/rabbitmq.svg'),
        },
        {
          name: "Redis Cache",
          description:
        ...
        },
        {
          ...
          image: assetUrl('kafka.svg'),
        },
      ],
    },
    {
      id: "orm",
      title: "ORM & SQL builder",
      items: [
        {
          name: "Hibernate",
          description:
        ...
        },
        {
          name: "Knex JS",
          description:
            "Knex.js batteries included SQL query builder for PostgreSQL, CockroachDB, MSSQL, MySQL, MariaDB, SQLite3, Better-SQLite3, Oracle, and Amazon Redshift designed to be flexible, portable, and fun to use.",
    ...
    },
    {
      ...
      subtitle: "Component, Styling, & Templating",
      items: [
        {
          name: "Flowbite",
          description:
            "Flowbite is a popular UI component library designed for Tailwind CSS, providing a set of accessible and customizable components for building modern web applications.",
          link: "https://flowbite.com/",
          image: assetUrl('flowbite.svg'),
        },
        {
          name: "Splade",
          description:
    ...
    {
      id: "eventlistener",
      title: "Document Object Manipulation",
      subtitle: "Library Supporting DOM",
      items: [
        {
          name: "jQuery",
          description:
            "jQuery is a fast, small, and feature-rich JavaScript library that simplifies things like HTML document traversal and manipulation.",
    ...
    {
      id: "documentation",
      title: "Documentation Project & Workspace Collaboration",
      items: [
        {
          name: "Affine",
          description:
            "AFFiNE is an open-source, all-in-one workspace that combines the features of note-taking, project management, and collaboration tools like Notion",
          link: "https://affine.pro",
          image: assetUrl('affine.svg'),
        },
        {
          name: "Atlassian",
          description:
            "Atlassian provides software products for project management, software development, and team collaboration.",
          link: "https://www.atlassian.com/",
          image: assetUrl('atlassian.svg'),
        },
        {
          name: "Jira",
          description:
            "Jira is a tool developed by Atlassian used for issue tracking and project management.",
          link: "https://www.atlassian.com/software/jira",
          image: assetUrl('jira.svg'),
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Daily.Dev",
          description:
            "Daily.dev is a professional network for developers, designed to help them improve their skills, collaborate with like-minded individuals, and grow within the developer community. ",
          link: "https://daily.dev",
          image: assetUrl('dailydev.svg'),
        },
      ],
    },
    {
      id: "deployment",
      title: "Infrastructure & Tools Building",
      items: [
        {
          name: "Docker",
          description:
            "Docker is a software platform that facilitates building, testing, and deploying applications efficiently by packaging them into standardized units called containers.",
          link: "https://www.docker.com",
          image: assetUrl('docker.svg'),
        },
        {
          name: "Microsoft Loop",
          description:
            "Loop is a note-taking platform that helps users organize, collaborate, and manage their notes efficiently.",
          link: "https://loop.cloud.microsoft/learn",
          image: assetUrl('loop.svg'),
        },
        {
          name: "Vercel",
          description:
          ...
          image: assetUrl('vercel-icon-dark.svg'),
        },
        {
          name: "Linux",
          description:
            "Linux is a free and open-source operating system kernel used in many distributions for servers, desktops, and embedded systems.",
          link: "https://ubuntu.com/",
          image: assetUrl('linux.svg'),
        },
        {
          name: "AWS",
          description:
            "Amazon Web Services (AWS) offers a comprehensive suite of cloud services for computing, storage, and networking.",
          link: "https://aws.amazon.com/",
          image: assetUrl('aws.svg'),
        },
        {
          name: "GitHub",
          description:
        ...
        },
        {
          ...
          image: assetUrl('apache.svg'),
        },
        {
          name: "Microsoft Azure",
          description:
            "Microsoft Azure is a cloud computing platform, which you can think of as a giant digital toolbox with a seemingly endless supply of resources.",
          link: "https://azure.microsoft.com/en-us/",
          image: assetUrl('azure.svg'),
        },
      ],
    },
    {
      id: "bundler",
      title: "Bundler Asset Optimization & Configuration",
      items: [
        {
          name: "Vite",
          description:
    ...
    {
      id: "supportinglib",
      title: "Other Tools Supporting",
      subtitle:
        "Text Editor, Testing, Depedency Library, UI Design, & LLM Search",
      items: [
        {
          ...
          image: assetUrl('vscode.svg'),
        },
        {
          name: "Figma",
          description:
            "Figma is a powerful, collaborative design tool for teams. Explore ideas and gather feedback, build realistic prototypes.",
          link: "https://www.figma.com",
          image: assetUrl('figma.svg'),
        },
        {
          name: "Postman",
          description:
          ...
          image: assetUrl('postman.svg'),
        },
        {
          name: "ApiDog",
          description:
            "ApiDog offers tools and services for testing and monitoring APIs to ensure their functionality and performance.",
          link: "https://apidog.com/",
          image: assetUrl('apidog-icon.svg'),
        },
        {
          name: "ChatGPT",
          description:
          ...
          image: assetUrl('openai.svg'),
        },
        {
          name: "Spatie",
          description:
            "Spatie is a web development company that provides a wide range of open-source packages for Laravel and other PHP projects.",
          link: "https://spatie.be/",
          image: assetUrl('spatie.svg'),
        },
        {
          name: "Swiper",
          description:
          ...
          image: assetUrl('swipper.svg'),
        },
        {
          name: "API-Ninjas",
          description:
            "API Ninjas is a data company that enables you to build real applications using real data. API Ninjas maintains 78 APIs",
          link: "https://api-ninjas.com/",
          image: assetUrl('ninja.png'),
        },
        {
          name: "Laravel Reverb",
          description:
      ...
      items: [
        {
          name: "Contentful",
          description:
            "Contentful is a cloud-based content management system (CMS) that allows users to create, store, and manage content for websites, mobile apps, and other platforms. ",
          link: "https://www.contentful.com/",
          image: assetUrl('contentful.png'),
        },
      ],
    },
  ];
  ...
  ngOnInit(): void {
    this.categories.forEach((cat) =>
      cat.items.forEach(
        (item) => (this.expandedState[this.getKey(cat.id, item.name)] = false),
      ),
    );
  }

  toggleReadMore(categoryId: string, itemName: string): void {
    const key = this.getKey(categoryId, itemName);
    this.expandedState[key] = !this.expandedState[key];
  }

  isExpanded(categoryId: string, itemName: string): boolean {
    return this.expandedState[this.getKey(categoryId, itemName)];
  }

  private getKey(categoryId: string, itemName: string): string {
    return `${categoryId}_${itemName}`;
  }
}
